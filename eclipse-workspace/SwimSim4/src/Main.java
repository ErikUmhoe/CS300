...
public class Main {
	...
	public static void update(Data data) {
		...
		/*data.fishPositions = moveAllObjects(data.fishPositions,1,0, data.processing.width, data.processing.height);
		data.foodPositions = moveAllObjects(data.foodPositions,-1,1, data.processing.width, data.processing.height);
		data.hookPositions = moveAllObjects(data.hookPositions,0,-1, data.processing.width, data.processing.height);
