...
/**
 * This class creates an iterable Integer that can be iterated upon to increase the number in a way defined
...
public class NumberGenerator implements Iterable<Integer>, Iterator<Integer>, Function<Integer,Integer>{
	...
	// Function to be passed in that decides what to do to the numbers.
	...
	public NumberGenerator(int numberOfEvens, Integer firstEven, Function<Integer, Integer> num) throws IllegalArgumentException {
		current = firstEven;
		if(current < 0)	// Checks to make sure the even entered is positive
